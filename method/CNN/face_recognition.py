...
class face_recognition:
    ...
    def train(self):
        ...
        for (i, imagePath) in enumerate(imagePaths):
            ...
            boxes = face_recognition_lib.face_locations(rgb,
                model=self.detection_method)

            # compute the facial embedding for the face
            encodings = face_recognition_lib.face_encodings(rgb, boxes)
    ...
    def detection_img(self):
        ...
        for encoding in encodings:
            ...
            # encodings
            matches = face_recognition_lib.compare_faces(data["encodings"],
                encoding)
            name = "Unknown"
    ...
    def detection_vid(self):
        ...
        while True:
            ...
            if writer is None and self.outputvideo is not None:
                fourcc = cv2.VideoWriter_fourcc(*"MJPG")
                writer = cv2.VideoWriter(self.outputvideo, fourcc, 20,
    ...
    def detection_vid_file(self):
        ...
        stream = cv2.VideoCapture(self.inputvideo)
        writer = None
        ...
        while True:
            ...
            if writer is None and self.outputvideo is not None:
                fourcc = cv2.VideoWriter_fourcc(*"MJPG")
                writer = cv2.VideoWriter(self.outputvideo, fourcc, 24,
                    (frame.shape[1], frame.shape[0]), True)
